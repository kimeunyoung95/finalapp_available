...
public class DateGridFragment extends Fragment {
    ...
    private com.roomorama.caldroid.CaldroidGridAdapter gridAdapter;
    ...
    public com.roomorama.caldroid.CaldroidGridAdapter getGridAdapter() {
        return gridAdapter;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (gridViewRes == 0) {
            gridViewRes = com.caldroid.R.layout.date_grid_fragment;
        }
