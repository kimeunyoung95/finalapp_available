...
public class MyApplication extends Application {
        ...
        beaconManager.connect(new BeaconManager.ServiceReadyCallback() {
            ...
            public void onServiceReady() {
                beaconManager.startMonitoring(new Region(
                        ...
                        // 본인이 연결 할 비콘의 아이디 부분
                        UUID.fromString("24DDF411-8CF1-440C-87CD-E368DAF9C93E"),
        ...
        beaconManager.setMonitoringListener(new BeaconManager.MonitoringListener() {
            ...
            public void onEnteredRegion(Region region, List<Beacon> list) {
                ...
                if( nearestBeacon.getRssi() > -50)
                {
                    ...
                    showNotification("서울여자대학교 도서관", "신작 도서 알림이 있습니다");
                } else {
                    showNotification("비콘과 접속 중 ", "연결 중에 있습니다.");
                }
            }
    ...
    public void showNotification(String title, String message) {
        ...
        Notification notification = new Notification.Builder(this)
                ...
                .setTicker("[서울여자대학교] 1층 신작 도서 알람이 있습니다.")
                .setAutoCancel(true)
    ...
    private boolean isAlreadyRunActivity() {
        ...
        List<ActivityManager.RunningTaskInfo> task_info =
                activity_manager.getRunningTasks(99);
