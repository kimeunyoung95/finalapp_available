...
public class CaldroidFragment extends DialogFragment {
    ...
    private void setupDateGridPages(View view) {
        ...
        // MonthPagerAdapter
        final com.roomorama.caldroid.MonthPagerAdapter pagerAdapter = new MonthPagerAdapter(
        ...
        for (int i = 0; i < NUMBER_OF_PAGES; i++) {
            com.roomorama.caldroid.DateGridFragment dateGridFragment = fragments.get(i);
