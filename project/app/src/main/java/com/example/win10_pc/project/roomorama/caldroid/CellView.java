...
public class CellView extends TextView {
    ...
    public static final int STATE_TODAY = com.caldroid.R.attr.state_date_today;
    public static final int STATE_SELECTED = com.caldroid.R.attr.state_date_selected;
    public static final int STATE_DISABLED = com.caldroid.R.attr.state_date_disabled;
    public static final int STATE_PREV_NEXT_MONTH = com.caldroid.R.attr.state_date_prev_next_month;
